...
<body>
			...
			<div class="navbar-header navbar-left">
				...
				<div class="w3_navigation_pos">
					...
					<div>
						...
						<jsp:useBean id="user1" class="user.userBean" scope="session" />
						<%
							request.setCharacterEncoding("UTF-8");
							session.getAttribute("user1");
							session.setAttribute("user2", user1);
						%>
						<form name="form1" method="get" action="MessServlet">
							<textarea name="message">（在此输入你的留言）</textarea>
							<br> <input type="submit" value="提交">
						</form>
						<form name="form2" method="get">
							<input type="button" value="返回"
								onclick="window.location.href='MyJsp.jsp'">
						</form>
						<a href="map.jsp">查看地图</a><br>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="w3lsaboutaits-grids">
				...
				<c:forEach var="list" items="${list }" begin="0" end="3">
					...
					<div class="modal fade details-modal" id="myModal<%=j++%>"
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<img src="${list.image }" alt="Odyssey">
									<p>${list.essay }</p>
								</div>
							</div>
						</div>
	...
	<div class="wthreelocationsaits" id="wthreelocationsaits">
		<div class="container">
			...
			<div class="grid-wrap">
				<div class="grid">
					<c:forEach var="list" items="${list }" begin="10" end="15">
						<figure class="col-md-4 effect-zoe"> <img
							src="${list.image }" alt="Odyssey"> <figcaption>
						<h4>${list.title }</h4>
						</figcaption></figure>
					</c:forEach>
			...
			<div class="content">
				<c:forEach var="list" items="${list }" begin="10" end="15">
					<div>
						...
						<p class="dummy-text aitsheadingw3">${list.title }</p>
						<p class="dummy-text">${list.essay }</p>
					</div>
				</c:forEach>
	...
	<div class="agilepackagesw3l" id="agilepackagesw3l">
		<div class="container">
			...
			<div id="owl-demo" class="owl-carousel text-center">
				<c:forEach var="list" items="${list }" begin="108" end="113">
					<div class="item w3-agile">
						...
						<div class="agilegrid agilegrid1">
							...
							<div class="sign w3-agile text-center">
								<a class="popup-with-zoom-anim" href="#small-dialog">BOOK
									NOW</a>
							</div>
						</div>
	...
	<div class="w3portfolioaits" id="w3portfolioaits">
		...
		<div class="w3portfolioaits-items">
			<c:forEach var="list" items="${list }" begin="150" end="161">
				<div
					class="col-md-3 w3portfolioaits-item w3portfolioaits-item-<%=i++%>">
					<a class="example-image-link" href="${list.image }"
						data-lightbox="example-set" data-title="">
						<div class="grid">
							<figure class="effect-apollo"> <img src="${list.image }"
								alt="Game Robo"> <figcaption></figcaption> </figure>
						</div>
					</a>
				</div>
			</c:forEach>
	...
	<div class="wthreereviews" id="wthreereviews">
		...
		<div class="cd-image-block">
			<ul class="cd-images-list">
				<c:forEach var="list" items="${list }" begin="50" end="53">
					<li class="is-selected agiletravelerw3ls agiletravelerw3ls1"><a
						href="#0">
							<h3>${list.title }</h3> <img src="${list.image }" alt="Odyssey">
							<h4>${list.id }</h4>
