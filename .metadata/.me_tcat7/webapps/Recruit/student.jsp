    ...
    <div data-options="region:'west',title:'系统菜单',split:true" style="width:200px;">
    	<div id="aa" class="easyui-accordion" style="width:193px;" data-options="border:0,multiple:true" >   
		    <div title="企业信息" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">   
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="student_enterInfo.jsp">企业信息</a></li>
		       </ul>
		    </div>  
		     <div title="招聘职位" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">   
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="customer_manage.jsp">招聘职位</a></li>
		       </ul>
		    </div>   
		    <div title="个人中心" data-options="iconCls:'icon-reload',selected:true" style="padding:10px;">   
		       <ul>
		       	 <li><a href="javascript:void(0)" pageUrl="customer_manage.jsp">个人信息</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="linkman_manage.jsp">简历管理</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="linkman_manage.jsp">职位申请进度</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="linkman_manage.jsp">消息</a></li>
		       	 <li><a href="javascript:void(0)" pageUrl="linkman_manage.jsp">留言咨询</a></li>
		       </ul>
		    </div>      
		</div>  
    </div>   
