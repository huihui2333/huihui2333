 ...
 * Generated at: 2020-02-19 05:55:04 UTC
...
public final class enterprise_005fprize_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t<!-- 编辑窗口 -->\r\n");
      out.write("\t<div id=\"win\" class=\"easyui-window\" title=\"奖品管理\" style=\"width:500px;height:300px\"   \r\n");
      out.write("        data-options=\"iconCls:'icon-save',modal:true,closed:true\">   \r\n");
      out.write("\t    <form id=\"editForm\" method=\"post\">\r\n");
      out.write("\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"prize_id\"> \r\n");
      out.write("\t\t\t             奖品名称：<input type=\"text\" name=\"prize_name\" class=\"easyui-textbox\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"required:true\" /><br /> \r\n");
      out.write("\t\t\t            奖品数量：<input type=\"text\" name=\"prize_amount\" class=\"easyui-textbox\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"required:true\" /><br /> <br /> \r\n");
      out.write("\t\t\t\t<a id=\"saveBtn\" href=\"#\" class=\"easyui-linkbutton\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"iconCls:'icon-save'\">保存</a>\r\n");
      out.write("\t\t</form> \r\n");
      out.write("\t</div>  \r\n");
      out.write("\t\r\n");
      out.write("\t<div id=\"winn\" class=\"easyui-window\" title=\"查看奖品信息\" style=\"width:500px;height:300px\"   \r\n");
      out.write("        data-options=\"iconCls:'icon-save',modal:true,closed:true\">   \r\n");
      ...
      out.write("\t\t\t              奖品数量：<input type=\"text\" name=\"prize_amount\" class=\"easyui-textbox\"\r\n");
      out.write("\t\t\t\t\tdata-options=\"required:false\" /><br />\r\n");
      out.write("\t\t\t\t获奖人    ：<input type=\"text\" name=\"user_id\" class=\"easyui-textbox\"\r\n");
      ...
      out.write("  \t\t\t\turl:\"customer/listPrizeByPage.action\",\r\n");
      out.write("  \t\t\t\t//columns：填充的列数据\r\n");
      out.write("  \t\t\t\t\t//field:后台对象的属性\r\n");
      out.write("  \t\t\t\t\t//tille:列标题\r\n");
      out.write("  \t\t\t\tcolumns:[[\r\n");
      out.write("  \t\t\t\t\t{\r\n");
      out.write("  \t\t\t\t\t\tfield:\"prize_id\",\r\n");
      out.write("  \t\t\t\t\t\ttitle:\"奖品编号\",\r\n");
      out.write("  \t\t\t\t\t\twidth:100,\r\n");
      out.write("  \t\t\t\t\t\tcheckbox:true\r\n");
      out.write("  \t\t\t\t\t},\r\n");
      out.write("  \t\t\t\t\t{\r\n");
      out.write("  \t\t\t\t\t\tfield:\"prize_name\",\r\n");
      out.write("  \t\t\t\t\t\ttitle:\"奖品名称\",\r\n");
      out.write("  \t\t\t\t\t\twidth:200\r\n");
      out.write("  \t\t\t\t\t},\r\n");
      out.write("  \t\t\t\t\t{\r\n");
      out.write("  \t\t\t\t\t\tfield:\"prize_amount\",\r\n");
      out.write("  \t\t\t\t\t\ttitle:\"奖品数量\",\r\n");
      out.write("  \t\t\t\t\t\twidth:200\r\n");
      out.write("  \t\t\t\t\t},\r\n");
      out.write("  \t\t\t\t\t{\r\n");
      ...
      out.write("  \t\t\t\t\turl:\"customer/savePrize.action\",\r\n");
      ...
      out.write("  \t\t\t\t\r\n");
      out.write("  \t\t\t\t//表单回显\r\n");
      out.write("  \t\t\t\t$(\"#searchForm\").form(\"load\",\"customer/findPrizeById.action?id=\"+rows[0].prize_id);\r\n");
      out.write("  \t\t\t\t\r\n");
      ...
      out.write("  \t\t\t\t\r\n");
      out.write("  \t\t\t\t//表单回显\r\n");
      out.write("  \t\t\t\t$(\"#editForm\").form(\"load\",\"customer/findPrizeById.action?id=\"+rows[0].prize_id);\r\n");
      out.write("  \t\t\t\t\r\n");
      out.write("  \t\t\t\t$(\"#win\").window(\"open\");\r\n");
      out.write("  \t\t\t});\r\n");
      out.write("  \t\t\t\r\n");
      ...
      out.write("  \t\t\t\t\t\t\tidStr+=(\"id=\"+rows[i].prize_id+\"&\");\r\n");
      out.write("  \t\t\t\t\t\t});\r\n");
      out.write("  \t\t\t\t\t\tidStr = idStr.substring(0,idStr.length-1);\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\t\t//传递到后台\r\n");
      out.write("  \t\t\t\t\t\t$.post(\"customer/deletePrize.action\",idStr,function(data){\r\n");
      out.write("  \t\t\t\t\t\t\tif(data.success){\r\n");
      out.write("  \t  \t\t\t\t\t\t\t//刷新datagrid\r\n");
      out.write("  \t  \t\t\t\t\t\t\t$(\"#list\").datagrid(\"reload\");\r\n");
      out.write("  \t  \t\t\t\t\t\t\t\r\n");
